...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold mb-6">Crear Nuevo Contratista</h2>

        <form action="{{ route('contratistas.store') }}" method="POST" class="space-y-6">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="razon_social" id="razon_social" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
            </div>
