...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <h2 class="text-2xl font-semibold leading-tight mb-5">Crear Nuevo Contrato</h2>

        <form action="{{ route('contratos.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            ...
            <div class="mb-4">
                ...
                <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                    ...
                    @foreach($contratistas as $contratista)
                        <option value="{{ $contratista->id_contratista }}" {{ old('id_contratista') == $contratista->id_contratista ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                    ...
                    @foreach($formasPago as $formaPago)
                        <option value="{{ $formaPago->id_forma_pago }}" {{ old('id_forma_pago') == $formaPago->id_forma_pago ? 'selected' : '' }}>
                            {{ $formaPago->nombre }}
                        </option>
                    @endforeach
                </select>
