...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold mb-6">Crear Nueva Meta</h2>
        ...
        <form action="{{ route('metas.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="meta_programa" id="meta_programa" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('meta_programa') }}</textarea>
            </div>
